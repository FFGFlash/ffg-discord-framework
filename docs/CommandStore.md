...
- [isArray](../wiki/CommandStore#isarray)
...
[src/commands.ts:91](https://github.com/FFGFlash/ffg-discord-framework/blob/031ed78/src/commands.ts#L91)
...
▸ **copyWithin**(`target`, `start`, `end?`): [`CommandStore`](../wiki/CommandStore)
...
▸ **filter**(`predicate`, `thisArg?`): [`ICommand`](../wiki/ICommand)[]
...
[src/commands.ts:69](https://github.com/FFGFlash/ffg-discord-framework/blob/031ed78/src/commands.ts#L69)
...
[src/commands.ts:49](https://github.com/FFGFlash/ffg-discord-framework/blob/031ed78/src/commands.ts#L49)
...
[src/commands.ts:107](https://github.com/FFGFlash/ffg-discord-framework/blob/031ed78/src/commands.ts#L107)
...
Either null or the command removed from the command store

#### Defined in

[src/commands.ts:58](https://github.com/FFGFlash/ffg-discord-framework/blob/031ed78/src/commands.ts#L58)
